      ...
      <section className="h-[100vh] bg-topBanner bg-cover bg-center bg-no-repeat bg-blend-overlay relative">
        ...
        <div className="h-full w-full flex flex-col items-center justify-center gap-20">
          ...
          <div className="z-50 w-full flex flex-col gap-5 items-center justify-center px-5">
            <input className="bg-gray-200 md:w-1/2 w-full py-3 px-5 rounded-lg focus:outline-none md:text-lg" required type="email" name="" id="" placeholder='your email' />
            <button className='bg-LightSalmon px-5 py-3 md:w-1/2 w-full md:text-xl uppercase font-semibold text-MidnightBlue rounded-lg'>Sign up now for a coupne code</button>
          </div>
        </div>
      </section>
    );
