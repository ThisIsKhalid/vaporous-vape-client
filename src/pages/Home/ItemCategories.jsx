    ...
    return (
      <section className="px-5 py-16 bg-NavajoWhite/30">
        ...
        <div className="grid grid-cols-2 gap-5 mt-10">
          <div className="border-2 border-MediumPurple rounded-lg bg-MediumPurple">
            <img className="w-full rounded-t-lg" src={vapes} alt="" />
            <div className="my-5 pl-5">
              <p className="text-xl font-medium text-gray-100 mb-2">Vape Devices</p>
              <button className="bg-LightSalmon px-5 py-3 uppercase font-semibold text-MidnightBlue rounded-lg">
                Find Out More
              </button>
            </div>
          </div>
          <div className="border-2 border-MediumPurple rounded-lg bg-MediumPurple">
            ...
            <div className="my-5 pl-5">
              <p className="text-xl font-medium text-gray-100 mb-2">E-liquids & Salt</p>
              <button className="bg-LightSalmon px-5 py-3 uppercase font-semibold text-MidnightBlue rounded-lg">
                Find Out More
              </button>
            </div>
